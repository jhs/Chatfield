...
function createPassportWizard(): Interview {
  ...
  return (
    chatfield()
      ...
      .as_one('online through internet', 'in-office at passport office')
      ...
      .as_one('in Poland', 'abroad at Polish consulate')
      ...
      .desc(
        'Based on the application choices, provide a comprehensive summary of recommended next steps',
      )
      .conclude()
