  ...
  describe('restaurant order', () => {
    ...
    test('adapts to vegan preferences', async () => {
      ...
      const allMessages = [
        ...
        toolCall('update_Restaurant_Order', {
          starter: {
            value: 'Garden salad',
  ...
  describe('job interview', () => {
    ...
    test('detects career changer', async () => {
      ...
      const allMessages = [
        null,
        new AIMessage(
          "Hello! Let's start with your experience. Can you tell me about your relevant experience?",
        ),
        ...
        toolCall('update_JobInterview', {
          experience: {
            value:
              'I spent 5 years in finance but taught myself programming. I built a trading algorithm in Python that automated our daily reports, saving the team 20 hours per week. I also created a dashboard using React.',
          },
          has_mentored: {
    ...
    test('handles technical interview', async () => {
      ...
      const allMessages = [
        ...
        toolCall('update_JobInterview', {
          experience: {
            value:
              'I have 8 years of experience as a full-stack developer. Most recently, I led the redesign of our e-commerce platform, improving load times by 40% and increasing conversion rates.',
          },
          has_mentored: {
  ...
  describe('number conversation', () => {
    ...
    test('collects number with transformations', async () => {
      ...
      const allMessages = [
        ...
        toolCall('update_FavoriteNumber', {
          number: {
            value: '42',
            as_int: 42,
            as_bool_even: true,
