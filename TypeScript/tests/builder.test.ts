...
describe('Builder', () => {
  ...
  describe('transformations', () => {
    it('applies type transformations', () => {
      ...
      expect(
        instance._chatfield.fields.age?.casts && 'as_int' in instance._chatfield.fields.age.casts,
      ).toBe(true);
      expect(
        instance._chatfield.fields.salary?.casts &&
          'as_float' in instance._chatfield.fields.salary.casts,
      ).toBe(true);
      expect(
        instance._chatfield.fields.active?.casts &&
          'as_bool' in instance._chatfield.fields.active.casts,
      ).toBe(true);
      expect(
        instance._chatfield.fields.confidence?.casts &&
          'as_percent' in instance._chatfield.fields.confidence.casts,
      ).toBe(true);
    });
    ...
    it('handles choice cardinality with clearer nullable naming', () => {
      ...
      const optionalColorCast =
        instance._chatfield.fields.optional_color?.casts?.as_nullable_one_selection;
      ...
      const optionalLangCast =
        instance._chatfield.fields.optional_languages?.casts?.as_nullable_multi_selection;
  ...
  describe('edge cases', () => {
    it('creates empty interview', () => {
      const instance = chatfield().type('Empty').desc('Empty interview').build();
